package Ocean::Cluster::Backend::ProjectTemplate::LayoutDesigner;
...
use Ocean::Cluster::Backend::ProjectTemplate::Layout::File::Readme;
use Ocean::Cluster::Backend::ProjectTemplate::Layout::File::Starter;
...
sub design {
    ...
    $self->_design_log_layout( $layout, $context );
...
sub _design_root_layout {
    ...
    $layout->add_file(
        Ocean::Cluster::Backend::ProjectTemplate::Layout::File::Readme->new );
}
...
sub _design_bin_layout {
    ...
    my $starter_file = Ocean::Cluster::Backend::ProjectTemplate::Layout::File::Starter->new;
...
sub _design_log_layout {
    ...
    $layout->add_dir(q{log});
    $layout->register_path('log_dir' => q{log});
}
