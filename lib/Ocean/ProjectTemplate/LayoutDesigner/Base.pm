package Ocean::ProjectTemplate::LayoutDesigner::Base;
...
use Ocean::ProjectTemplate::Layout::File::Readme;
use Ocean::ProjectTemplate::Layout::File::Starter;
use Ocean::ProjectTemplate::Layout::File::Stopper;
...
sub _design_bin_layout {
    ...
    $bin_dir->add_file(
        Ocean::ProjectTemplate::Layout::File::Stopper->new );
}
...
sub _design_root_layout {
    my ($self, $layout, $context) = @_;
    $layout->add_file(
        Ocean::ProjectTemplate::Layout::File::Readme->new );
}
