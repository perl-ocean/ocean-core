package Ocean::Cluster::Backend::Handler::People;
...
sub on_roster_request {
    ...
    Ocean::Error::AbstractMethod->throw(
        message => q{Ocean::Cluster::Backend::Handler::People::on_roster_request}, 
    );
}
...
sub on_vcard_request {
    my ($self, $ctx, $node_id, $args) = @_;
    Ocean::Error::AbstractMethod->throw(
        message => q{Ocean::Cluster::Backend::Handler::People::on_vcard_request}, 
    );
}
