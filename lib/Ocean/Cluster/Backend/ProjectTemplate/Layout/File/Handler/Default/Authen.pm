package Ocean::Cluster::Backend::ProjectTemplate::Layout::File::Handler::Default::Authen;
...
=head2 on_too_many_auth_attempt( $ctx, $node_id, $args )
...
=head2 on_http_auth_request( $ctx, $node_id, $args )
...
=head2 on_sasl_auth_request( $ctx, $node_id, $args )
...
=head2 on_sasl_password_request( $ctx, $node_id, $args )
...
=head2 on_sasl_success_notification( $ctx, $node_id, $args )
