package Ocean::XML::StanzaParser::RoomListRequest;
...
use Ocean::Stanza::Incoming::RoomListRequest;
...
sub parse {
    ...
    return Ocean::Stanza::Incoming::RoomListRequest->new($element->attr('id'));
}
