package Ocean::Stanza::DeliveryRequestBuilder::RoomInvitationDecline;
...
sub type  { Ocean::Constants::EventType::DELIVER_ROOM_INVITATION_DECLINE }
...
sub build_args {
    ...
    ) unless exists $self->{_decliner};

    $args->{decliner} = $self->{_decliner};
