...
my %EVENTS = (
    ...
    'room_info_request'               => Ocean::Constants::EventType::ROOM_INFO_REQUEST,
    'room_list_request'               => Ocean::Constants::EventType::ROOM_LIST_REQUEST,
    'room_members_list_request'       => Ocean::Constants::EventType::ROOM_MEMBERS_LIST_REQUEST,
    'room_invitation'                 => Ocean::Constants::EventType::ROOM_INVITATION,
    'room_invitation_decline'         => Ocean::Constants::EventType::ROOM_INVITATION_DECLINE,
    'send_room_message'               => Ocean::Constants::EventType::SEND_ROOM_MESSAGE,
