package Ocean::XML::StanzaParser::RoomServiceInfoRequest;
...
use Ocean::Stanza::Incoming::RoomServiceInfoRequest;
...
sub parse {
    ...
    return Ocean::Stanza::Incoming::RoomServiceInfoRequest->new(
        $element->attr('id'));
}
