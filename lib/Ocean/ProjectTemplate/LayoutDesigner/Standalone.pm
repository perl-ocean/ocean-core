package Ocean::ProjectTemplate::LayoutDesigner::Standalone;
...
use Ocean::ProjectTemplate::Layout::File::Handler::Standalone::Node;
use Ocean::ProjectTemplate::Layout::File::Handler::Standalone::Authen;
use Ocean::ProjectTemplate::Layout::File::Handler::Standalone::Connection;
use Ocean::ProjectTemplate::Layout::File::Handler::Standalone::Message;
use Ocean::ProjectTemplate::Layout::File::Handler::Standalone::People;
use Ocean::ProjectTemplate::Layout::File::Handler::Standalone::Room;
use Ocean::ProjectTemplate::Layout::File::Handler::Standalone::P2P;

use Ocean::ProjectTemplate::Layout::File::Context::Standalone;
use Ocean::ProjectTemplate::Layout::File::Config::Standalone;
...
sub _design_config_layout {
    ...
    my $config_file = Ocean::ProjectTemplate::Layout::File::Config::Standalone->new;
...
sub _design_lib_layout {
    ...
    $self->add_module_file(
        ...
        Ocean::ProjectTemplate::Layout::File::Context::Standalone->new );

    $self->add_module_file(
        $layout, $lib_dir, q{lib}, join('::', $context->get('handler_class'), 'Node'), 
        Ocean::ProjectTemplate::Layout::File::Handler::Standalone::Node->new );
    $self->add_module_file(
        $layout, $lib_dir, q{lib}, join('::', $context->get('handler_class'), 'Authen'), 
        Ocean::ProjectTemplate::Layout::File::Handler::Standalone::Authen->new );
    $self->add_module_file(
        $layout, $lib_dir, q{lib}, join('::', $context->get('handler_class'), 'Connection'), 
        Ocean::ProjectTemplate::Layout::File::Handler::Standalone::Connection->new );
    $self->add_module_file(
        $layout, $lib_dir, q{lib}, join('::', $context->get('handler_class'), 'Message'), 
        Ocean::ProjectTemplate::Layout::File::Handler::Standalone::Message->new );
    $self->add_module_file(
        $layout, $lib_dir, q{lib}, join('::', $context->get('handler_class'), 'People'), 
        Ocean::ProjectTemplate::Layout::File::Handler::Standalone::People->new );
    $self->add_module_file(
        $layout, $lib_dir, q{lib}, join('::', $context->get('handler_class'), 'Room'), 
        Ocean::ProjectTemplate::Layout::File::Handler::Standalone::Room->new );
    $self->add_module_file(
        $layout, $lib_dir, q{lib}, join('::', $context->get('handler_class'), 'P2P'), 
        Ocean::ProjectTemplate::Layout::File::Handler::Standalone::P2P->new );
}
