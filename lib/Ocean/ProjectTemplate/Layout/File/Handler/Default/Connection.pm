package Ocean::ProjectTemplate::Layout::File::Handler::Default::Connection;
...
=head2 on_bind_request( $ctx, $args )
...
=head2 on_silent_disconnection( $ctx, $args )
...
=head2 on_initial_presence( $ctx, $args )
...
=head2 on_unavailable_presence( $ctx, $args )
