package Ocean::Cluster::Backend::Handler::Connection;
...
sub on_bind_request {
    ...
    Ocean::Error::AbstractMethod->throw(
        message => q{Ocean::Cluster::Backend::Handler::Connection::on_bind_request}, 
    );
}
...
sub on_presence {
    my ($self, $ctx, $node_id, $args) = @_;
    Ocean::Error::AbstractMethod->throw(
        message => q{Ocean::Cluster::Backend::Handler::Connection::on_presence}, 
    );
}
...
sub on_initial_presence {
    my ($self, $ctx, $node_id, $args) = @_;
    Ocean::Error::AbstractMethod->throw(
        message => q{Ocean::Cluster::Backend::Handler::Connection::on_initial_presence}, 
    );
}
...
sub on_unavailable_presence {
    my ($self, $ctx, $node_id, $args) = @_;
    Ocean::Error::AbstractMethod->throw(
        message => q{Ocean::Cluster::Backend::Handler::Connection::on_unavailable_presence}, 
    );
}
...
sub on_silent_disconnection {
    my ($self, $ctx, $node_id, $args) = @_;
    Ocean::Error::AbstractMethod->throw(
        message => q{Ocean::Cluster::Backend::Handler::Connection::on_silent_disconnection}, 
    );
}
