package Ocean::Cluster::Backend::ProjectTemplate::Layout::File::Handler::Default::People;
...
=head2 on_roster_request( $ctx, $node_id, $args )
...
=head2 on_vcard_request( $ctx, $node_id, $args )
